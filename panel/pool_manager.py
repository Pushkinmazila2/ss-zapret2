...
class PoolManager:
    ...
    def get_traffic_stats(self):
        ...
        Additionally returns `conns`: number of established connections
        ...
        with self._lock:
            ...
            # Queues with connections but no counters (iptables counters are
    ...
    # -- per-slot active connection counts (connmark -> qnum) -------------
